# Plan.md — anthony-trollope_he-knew-he-was-right

---

## 本计划信息

- **项目名称**：anthony-trollope_he-knew-he-was-right（安东尼·特罗洛普《他知道自己是对的》）
- **源文目录**：原文/
- **译文目录**：译文/
...
| `原文/*.md` | 源文（01-99 两位数字前缀，即阅读顺序） | 不改 |
...
```
file,size_kb,status
01-showing-how-wrath-began.md,20.9,todo
02-colonel-osborne.md,20.5,todo
...
```

| 字段 | 含义 | 取值 |
|------|------|------|
| `file` | 源文文件名（在 `原文/` 目录下） | 如 `01-showing-how-wrath-began.md` |
...
共 99 章（01-99 两位数字前缀文件名，顺序即阅读顺序），详见 `translation_queue.csv`。
