# 翻译计划（jean-grave_moribund-society-and-anarchy_voltairine-de-cleyre）

## 本计划信息

- **项目名称**：jean-grave_moribund-society-and-anarchy_voltairine-de-cleyre（Moribund Society And Anarchy）
- **源文目录**：原文/
- **译文目录**：译文/
...
共 25 篇，见 `translation_queue.csv`（合计 390KB）。
