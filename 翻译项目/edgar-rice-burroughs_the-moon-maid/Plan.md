# Plan（edgar-rice-burroughs_the-moon-maid）

---

## 本计划信息

- **项目名称**：edgar-rice-burroughs_the-moon-maid（《月球女仆》The Moon Maid, Edgar Rice Burroughs, 1926）
- **源文目录**：原文/
- **译文目录**：译文/
- **译文命名**：原名.zh-CN.md（放译文目录）
- **领域配置**：prompts/领域配置/小说文学.md
- **术语表**：术语表.md
- **内容形态**：长篇（三部曲：01-16 第一部 / 17-28 第二部 / 29-40 第三部）→ **执行模式：委派**
...
```
file,size_kb,status
01-part-i-the-moon-maid.md,0.0,todo
02-the-message-from-mars.md,11.0,todo
...
```

| 字段 | 含义 | 取值 |
|------|------|------|
| `file` | 源文文件名（在 `原文/` 目录下） | 如 `13-laythe.md` |
...
共 40 篇（01-16 第一部「月球女仆」；17-28 第二部「月球人」；29-40 第三部「红鹰」+ 尾注）。详见 `translation_queue.csv`。
