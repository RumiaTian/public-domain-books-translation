...
- **项目名称**：voltairine-de-cleyre_short-fiction
- **源文目录**：原文/
- **译文目录**：译文/
...
由 `translation_queue.csv` 管理（14 篇，约 140KB）。
...
| 日期 | 篇目 | 结果 | 备注 |
|------|------|------|------|
| 2026-08-27 | 全书 14 篇 | 完成 14/14 | 子代理装配式直出（隐形字符机械抽取，missing lines=0），check 全过零拦截；定名已回填术语表 |
