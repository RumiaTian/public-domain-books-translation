...
- **项目名称**：《我们如今的生活方式》（The Way We Live Now）
- **源文目录**：原文/
- **译文目录**：译文/
...
```
file,size_kb,status
001-three-editors.md,12.3,todo
002-the-carbury-family.md,18.1,todo
...
```

| 字段 | 含义 | 取值 |
|------|------|------|
| `file` | 源文文件名（在 `原文/` 目录下） | 如 `001-three-editors.md` |
...
全书 100 章，文件已按 spine 顺序加三位数字前缀（001–100），由 `translation_queue.csv` 统一管理，此处不重复罗列。
