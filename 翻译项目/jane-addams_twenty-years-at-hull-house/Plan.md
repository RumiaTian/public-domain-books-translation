# 翻译计划（jane-addams_twenty-years-at-hull-house）

## 本计划信息

- **项目名称**：jane-addams_twenty-years-at-hull-house（Twenty Years At Hull House）
- **源文目录**：原文/
- **译文目录**：译文/
...
共 21 篇，见 `translation_queue.csv`（合计 596KB）。
