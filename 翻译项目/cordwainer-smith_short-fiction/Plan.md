...
- **项目名称**：cordwainer-smith_short-fiction（科特维纳·史密斯短篇科幻小说集）
- **源文目录**：原文/
- **译文目录**：译文/
...
```
file,size_kb,status
scanners-live-in-vain.md,12.9,todo
the-game-of-rat-and-dragon.md,12.1,todo
war-no-81-q.md,6.2,todo
```

| 字段 | 含义 | 取值 |
|------|------|------|
| `file` | 源文文件名（在 `原文/` 目录下） | 如 `war-no-81-q.md` |
...
> **谁执行**由 `项目说明.md` 的「内容形态」字段决定：本短篇集走**委派模式**，由子代理逐篇执行本 9 步流程。
...
| # | 篇名 | 源文 | 大小 | 状态 |
|---|------|------|------|------|
| 1 | Scanners Live in Vain（扫描器不屈而死） | scanners-live-in-vain.md | 12.9KB | todo |
| 2 | The Game of Rat and Dragon（鼠与龙的游戏） | the-game-of-rat-and-dragon.md | 12.1KB | todo |
| 3 | War No. 81-Q（第81-Q号战争） | war-no-81-q.md | 6.2KB | todo |
...
| 日期 | 篇目 | 结果 | 备注 |
|------|------|------|------|
| 2026-08-15 | War No. 81-Q（第81-Q号战争） | done | 6.2KB，check_bilingual 通过（13 对块，0 可疑） |
| 2026-08-15 | Scanners Live in Vain（扫描器不屈而死） | done | 12.9KB，check_bilingual 通过（17 对块，0 可疑） |
| 2026-08-14 | the-game-of-rat-and-dragon | done ×1（全书 3/3 译完） | exit 0 |
