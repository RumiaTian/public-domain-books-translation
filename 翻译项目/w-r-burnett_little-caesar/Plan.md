...
- **项目名称**：w-r-burnett_little-caesar（小凯撒 / Little Caesar）
- **源文目录**：原文/
- **译文目录**：译文/
...
全书 53 篇：前言 2 篇（献词、题词）+ 七部扉页 7 篇 + 各部章节 44 篇。完整清单由 `translation_queue.csv` 管理（已按阅读顺序：00- 前言 → part-N 扉页 → chapter-N-M 章节）。
...
| 日期 | 篇目 | 结果 | 备注 |
|------|------|------|------|
| 2026-08-30 | 全书 53 项（44 章＋7 部题＋献词题词） | 完成 53/53 | 批次1三段并行（A:1-3部 25 文件，B:4-5部 13，C:6-7部 15）；零[1301]零[1308]（黑帮题材全程无拦截）；部题文件单行标题 0 块过检新范式；收尾统一 2 处（麦科纳加/潘乔·比利亚）并勘误术语表 Ottavio 括注；剪报/通缉令/竖排霓虹招牌引文块逐字镜像 |
