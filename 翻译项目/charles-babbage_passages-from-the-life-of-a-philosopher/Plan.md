# 翻译计划（charles-babbage_passages-from-the-life-of-a-philosopher）

## 本计划信息

- **项目名称**：charles-babbage_passages-from-the-life-of-a-philosopher（Passages From The Life Of A Philosopher）
- **源文目录**：原文/
- **译文目录**：译文/
...
共 42 篇，见 `translation_queue.csv`（合计 839KB）。
