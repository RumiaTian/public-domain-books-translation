...
Value of a celebrated Name﻿—My Ancestors﻿—Their Ante-Mosaic origin﻿—Flint-workers﻿—Toolmakers﻿—Not descended from Cain﻿—Ought a Philosopher to avow it if he were?﻿—Probability of Descent from Tubal Cain﻿—Argument in favour, he worked in Iron﻿—On the other side, he invented Organs﻿—Possible origin of my Name﻿—Family History in very recent times.
