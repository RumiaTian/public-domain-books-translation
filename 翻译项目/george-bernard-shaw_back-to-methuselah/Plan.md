...
- **项目名称**：george-bernard-shaw_back-to-methuselah（《回到玛士撒拉》）
- **源文目录**：原文/
- **译文目录**：译文/
...
```
file,size_kb,status
0-preface.md,167.6,todo
2-part-1-in-the-beginning.md,58.3,todo
...
```

| 字段 | 含义 | 取值 |
|------|------|------|
| `file` | 源文文件名（在 `原文/` 目录下） | 如 `0-preface.md` |
...
> **谁执行**由 `项目说明.md` 的「内容形态」字段决定：本项目为短篇集 → 委派模式，子代理逐篇执行。9 步流程不变。
...
- 长文（源文 >50KB，本项目各篇均超）分段处理见通用翻译引擎第七节。
- 剧本对白行 `**人物名**：台词` 与舞台说明格式保持不变。
...
| # | 篇名 | 源文 | 大小 | 状态 |
|---|------|------|------|------|
| 1 | 序：不信神的半个世纪 | 0-preface.md | 167.6KB | todo |
| 2 | 剧中人物 | 1-dramatis-personae.md | 1.0KB | todo |
| 3 | 第一部 太初（公元前4004年） | 2-part-1-in-the-beginning.md | 58.3KB | todo |
| 4 | 第二部 巴纳巴斯兄弟的福音（现代） | 3-part-2-the-gospel-of-the-brothers-barnabas.md | 94.9KB | todo |
| 5 | 第三部 事情发生了（公元2170年） | 4-part-3-the-thing-happens.md | 80.5KB | todo |
| 6 | 第四部 一位老绅士的悲剧（公元3000年） | 5-part-4-tragedy-of-an-elderly-gentleman.md | 115.3KB | todo |
| 7 | 第五部 思之所极（公元31920年） | 6-part-5-as-far-as-thought-can-reach.md | 103.2KB | todo |
